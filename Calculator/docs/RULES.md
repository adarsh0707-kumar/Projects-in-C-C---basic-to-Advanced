...
Following these rules consistently will keep the codebase clean, scalable, and suitable for production-quality open-source developmen
...
Never use goto (except controlled cleanup)

Never use global mutable state unnecessarily

Always validate user input

Never call exit() from library modules
