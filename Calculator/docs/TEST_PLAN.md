...
| `test_validator.c`      | `validator.c`                      | `validateExpression()` accepts well-formed input and rejects malformed input (trailing operator, mismatched parens, wrong arg count, ...) |
| `test_parser.c`         | `parser.c`                         | Implicit-multiplication insertion (`2(3)`, `3pi`, ...); parenthesis balance validation |
